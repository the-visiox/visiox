...
def send_invitation_email(invitation):
    ...
    ">
      ...
      <h2 style="margin:0 0 8px;font-size:20px;font-weight:800;color:#1c1917">
        ...
        <span style="color:#f97316">{team_name}</span>
      </h2>
      <p style="margin:0 0 24px;color:#78716c;font-size:14px">
        <strong style="color:#1c1917">{inviter}</strong>
        has invited you to join the team as a
        <strong style="color:#1c1917">{role}</strong>.
      </p>
      <a href="{accept_url}"
         style="
           display:inline-block;
      ...
      <p style="margin:24px 0 0;color:#a8a29e;font-size:12px">
        This link expires in 7 days. If you did not expect this email,
        you can ignore it.
      </p>
    </div>
    """
